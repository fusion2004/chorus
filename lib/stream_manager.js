...
class StreamManager extends EventEmitter {
  ...
  async playSong(current) {
    this.fileStream = fs.createReadStream(current.song.path(announcerFinal), { highWaterMark: 65536 });
    this.shoutStream = new ShoutStream(this._shout);
    ...
    this.fileStream = fs.createReadStream(current.song.path(transcodeFinal), { highWaterMark: 65536 });
    this.shoutStream = new ShoutStream(this._shout);
